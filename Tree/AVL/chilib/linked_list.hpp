...
public:
  ...
  explicit linked_list(T &&d) : data(std::forward<T>(d)) {}
   ...
   */
  auto link(T &&d) {
    auto p = linked_list::make(std::forward<T>(d));
    this->link(p);
    return p;
  }

  auto link(T &d) {
    return this->link(std::forward<T>(d));
  }
  ...
  std::shared_ptr<linked_list<T>> link(std::shared_ptr<linked_list<T>> &p) {
    return this->link(std::forward<std::shared_ptr<linked_list<T>>>(p));
  }
  ...
  std::shared_ptr<linked_list<T>> append(std::shared_ptr<linked_list<T>> &p) {
    return this->append(std::forward<std::shared_ptr<linked_list<T>>>(p));
  }
 ...
 */
  static auto make(T &&d) {
    return std::make_shared<linked_list<T>>(std::forward<T>(d));
  }
 ...
 */
  ...
  public:
    ...
    linked_list<T> &operator*() { return *this->node; }

    linked_list<T> *operator->() { return &(operator*()); }
  };
 ...
 */
  ...
  auto push_back(T &d) {
    return this->push_back(std::forward<T>(d));
  }
 ...
 */
  ...
  auto emplace_back(T &d) {
    return this->emplace_back(std::forward<T>(d));
  }
